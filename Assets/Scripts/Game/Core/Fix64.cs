...
namespace FixMath.NET
{
    ...
    public partial struct Fix64 : IEquatable<Fix64>, IComparable<Fix64>
    {
        ...
        {
            return (val1.m_rawValue >= val2.m_rawValue) ? val1 : val2;
        }
        ...
        {
            return new Fix64((long)decimal.Round(value * ONE, 9));
        }
        ...
        public static int ToInt32(Fix64 value)
        {
            return (int)Round(value);
        }

        public static long ToInt64(Fix64 value)
        {
        ...
        {
            return (Fix64)decimal.Parse(str);
        }
