...
public struct ChaProperty{
    ...
    public ChaProperty(
        int moveSpeed, int hp = 0, int ammo = 0, int attack = 0, int actionSpeed = 100, int speed=100,
    ...
    public static ChaProperty operator *(ChaProperty a, ChaProperty b){
        return new ChaProperty(
            ...
            Mathf.RoundToInt(a.speed * (1.0000f + Mathf.Max(b.speed, -0.9999f))),
